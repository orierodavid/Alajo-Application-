...
export default async function AdminGroupsPage() {
  ...
  return <section className="p-5 sm:p-8 max-w-6xl mx-auto text-white">
    ...
    <div className="mt-8 grid gap-4">
      ...
      </article>}) : <div className="rounded-2xl border border-dashed border-[#355442] bg-[#0d1d13] p-10 text-center"><p className="font-semibold text-white">No groups created yet</p><p className="text-sm text-[#9fb3a8] mt-2">Create your first ZeePay savings group to begin filling positions.</p><Link href="/admin/groups/create" className="inline-flex mt-5 rounded-xl bg-[#16a34a] px-5 py-3 font-semibold text-white">Create first group</Link></div>}
    </div>
  </section>
}
