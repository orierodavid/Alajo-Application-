...
export default function AdminLoginPage() {
  ...
  return <main className="min-h-screen bg-[#f5faf7] dark:bg-[#07150c] flex items-center justify-center px-5 py-10">
    <section className="w-full max-w-md">
      <div className="text-center mb-8"><div className="mx-auto w-12 h-12 rounded-2xl bg-[#16a34a] text-white flex items-center justify-center font-black text-xl">Z</div><p className="mt-4 text-xs font-bold tracking-[0.22em] text-[#16a34a]">ZEEPAY ADMINISTRATION</p><h1 className="mt-2 text-3xl font-bold text-gray-950 dark:text-white">Administrator Login</h1><p className="mt-2 text-sm text-gray-500 dark:text-gray-400">Secure access to the ZeePay operations backend.</p></div>
      ...
      <p className="text-center text-xs text-gray-400 mt-5">ZeePay administrative access is restricted to authorized staff.</p>
    </section>
  </main>
}
