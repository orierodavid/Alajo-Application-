    ...
    <main className="min-h-screen bg-white grid lg:grid-cols-2">
      ...
      <section className="p-10 lg:p-14 flex flex-col justify-center">
        <div className="max-w-[430px] w-full mx-auto">
          ...
          <p className="mt-1 text-gray-500 text-[14px] leading-relaxed">Enter your 11-digit BVN and the bank account connected to it. This is required before a dedicated funding account can be created.</p>
