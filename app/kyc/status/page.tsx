    ...
    <main className="min-h-screen bg-white flex items-center justify-center px-6">
      <section className="w-full max-w-lg">
        ...
        <div className="mt-6 space-y-3">
          ...
          {!complete && !rejected && <Link href="/logout" className="block w-full rounded-md border border-gray-200 px-4 py-3 text-center text-sm font-semibold text-gray-700">Leave this page</Link>}
        </div>
      </section>
    </main>
  )
